...
# Description: Constraints file for the Basys 3 FPGA board
# Specifically for the "Flip That Digit" game where switches are numerically mapped starting from the leftmost switch
...
set_property PACKAGE_PIN W17 [get_ports {SWITCHES[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SWITCHES[12]}]
set_property PACKAGE_PIN W16 [get_ports {SWITCHES[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SWITCHES[13]}]
set_property PACKAGE_PIN V16 [get_ports {SWITCHES[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SWITCHES[14]}]
set_property PACKAGE_PIN V17 [get_ports {SWITCHES[15]}]					
